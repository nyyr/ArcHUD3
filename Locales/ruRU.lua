...
L["TEXT"] = {
	...
	REVERSEBUFFCOOLDOWNS = "Обратное время восстановления (де)баффы",
...
L["TOOLTIP"] = {
	...
	REVERSEBUFFCOOLDOWNS = "Обратное направление анимации перезарядки (де)баффы.",
...
LM["TEXT"] = {
	...
	COLORSTAGGERE = "Цвет для крайний пошатывания",

	SORTRUNES   = "Сортировать руны",
	
	INNERANCHOR = "Прикрепить дугу к внутреннему ('для питомца') месту",
	
	CUSTOM		= "Свои дуги (Вероятно, несовместимо с Midnight)",
...
LM["TOOLTIP"] = {
	...
	COLORSTAGGERE = "Изменить цвет для крайний пошатывания",
