...
L["TEXT"] = {
	...
	SHOWCOMBO	= "显示连击点文本",
	COMBODECAY	= "衰变延迟",
	HOLYPOWERCOMBO = "显示神圣能量作为连击点",
	SOULSHARDCOMBO = "显示灵魂碎片作为连击点",
	CHICOMBO 	= "显示真气作为连击点",
	RUNECOMBO 	= "Show Runes as combo points",
	SOULFRAGMENTCOMBO = "Show Soul Fragments as combo points",
	CPCOLOR		= "连击点颜色",
	CPCOLORDECAY = "连击点衰变的颜色",
	RESETCOLORS	= "重置颜色",
