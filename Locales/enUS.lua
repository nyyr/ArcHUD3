...
LM["TEXT"] = {
	...
	INDINTERRUPT= "Indicate non-interruptable spells",
	INDLATENCY  = "Indicate current network latency",
...
LM["TOOLTIP"] = {
	...
	INDINTERRUPT= "Toggle indication of non-interruptable spells. The casting arc will have a red outline for non-interruptable spells.",
	INDLATENCY  = "Toggle indication of current network latency. Once your cast arc passes the indicator, you should be safe to cast the next spell without getting an error. Note that this is only an estimation and thus could be inaccurate.",
