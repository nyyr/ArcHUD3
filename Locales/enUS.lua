...
LM["TEXT"] = {
	...
	INDLATENCY  = "Indicate lag tolerance",
...
LM["TOOLTIP"] = {
	...
	INDLATENCY  = "Toggle indication of lag tolerance. Once your cast arc passes the indicator, you should be safe to queue the next spell without getting an error. This indicator considers your spell queuing settings and the current network latency.",
